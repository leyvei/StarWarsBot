...
module.exports = {
    ...
    async execute(interaction) {
        ...
        if (interaction.channelId == 1092408254367289436) {
            try {
                const rolesToRemove = ['1092392660691599420', '1092396975560851516', '1092397344366010398', '1092397291832365146', '1092397215282102303', '1092397572058009661', '1092397485005213786', '1092397653708509205', '1092397737242284132', '1092448256874778704'];
                const matchingRoles = member.roles.cache.filter(r => rolesToRemove.includes(r.id));
                ...
                switch (role) {
                    ...
                    case '1092397737242284132':
                        ...
                        break;
                    default:
                        await interaction.reply({ content: 'Le rôle spécifié est invalide.', ephemeral: true });
                        break;
                }

                await interaction.reply({ content: `Le rôle <@&${role}> vous a été attribué avec succès.`, ephemeral: true });
            } catch (error) {
                await interaction.reply({ content: 'Une erreur est survenue lors de l\'attribution du rôle.', ephemeral: true });
            }
        } else {
            await interaction.reply({ content: "Veuillez effectuer cette commande dans le salon <#1092408254367289436>.", ephemeral: true })
        }
    },
};