...
module.exports = {
    data: new SlashCommandBuilder()
        .setName("nowplaying")
        .setDescription("Afficher des informations sur la chanson actuellement en lecture."),
    async execute(interaction) {
        ...
        try {
            ...
            embed.setColor("Blue").setDescription(`🎶 **En cours de lecture :** \`${song.name}\` - \`${song.formattedDuration}\`.\n**Lien :** ${song.url}`).setThumbnail(song.thumbnail);
            return interaction.reply({ embeds: [embed], ephemeral: true });
