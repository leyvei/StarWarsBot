...
module.exports = {
    data: new SlashCommandBuilder()
        .setName("forward")
        .setDescription("Avancer de quelques secondes dans une chanson.")
        .setDefaultMemberPermissions(PermissionFlagsBits.PrioritySpeaker)
        .addIntegerOption(option =>
            option.setName("secondes")
                .setDescription("Nombre de secondes à avancer. (10 = 10s)")
                .setMinValue(0)
                .setRequired(true)
        ),
    async execute(interaction) {
        ...
        try {
            ...
            embed.setColor("Blue").setDescription(`⏩ La chanson a été avancée de \`${seconds}s\`.`);
            return interaction.reply({ embeds: [embed], ephemeral: true });
