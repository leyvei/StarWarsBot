  ...
  execute: async (interaction) => {
    ...
    if (!Data) {
      return await interaction.reply({
        content:
          "Vous devez avoir un compte galactique pour retirer des crédits.",
        ephemeral: true,
      });
    }
    ...
    if (Data.Bank < amount) {
      return await interaction.reply({
        content:
          "Vous n'avez pas suffisamment de crédits dans votre compte bancaire pour retirer cette quantité.",
        ephemeral: true,
      });
    }
    ...
    interaction.reply({
      content: `Vous avez retiré ${amount} crédits de votre compte bancaire.`,
      ephemeral: true,
    });
  },
};
