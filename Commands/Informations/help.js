    ...
    async execute(interaction) {
        if (interaction.channelId == 1092385721622466642) {
            ...
            const embed = new Discord.EmbedBuilder()
                ...
                .setColor("#235ee7")
                .setAuthor({ name: `Commande du droïde ${client.user.username}`, iconURL: client.user.avatarURL() });
            ...
            collector.on("collect", (interaction) => {
                ...
                const categoryEmbed = new Discord.EmbedBuilder()
                    .setTitle(`Carte mémoire trouvée: ${emojis[directory.toLowerCase()] ? `${emojis[directory.toLowerCase()]}${formatString(directory)}` : formatString(directory)}`)
                    .setDescription(
            ...
            await interaction.reply({content: "Veuillez effectuer cette commande dans le salon <#1092385721622466642>.", ephemeral: true})
        }
    },
};