...
module.exports = {
  data: new Discord.SlashCommandBuilder()
    ...
    .addChannelOption((option) =>
      option
        .setName("channel")
        .setDescription(
          "Salon dans lequel sera affiché le message de bienvenue."
        )
        .setRequired(true)
    )
    .addRoleOption((option) =>
      option
        .setName("role")
        .setDescription("Entrer votre role par défaut")
        .setRequired(true)
    )
  ...
  execute: async (interaction) => {
    ...
    if (
      ...
      interaction.reply({
        content: "Je n'ai pas la permission d'effectuer cette commande",
        ephemeral: true,
      });
      return;
    }
    ...
    try {
      ...
      interaction.reply({
        content: "Nouveau message de bienvenue créé !",
        ephemeral: true,
      });
    } catch (error) {
      console.error(error);
      interaction.reply({
        content:
          "Une erreur s'est produite lors de la création du message de bienvenue.",
        ephemeral: true,
      });
    }
  },
